    ...
    <div className="min-h-screen bg-neutral-300/70">
      <div className="w-full sm:w-2/3 mx-auto">
        <div className="py-7 flex flex-col gap-4 items-center">
          <h2 className="py-4 text-3xl font-bold text-neutral-700">
            💥 TweetGPT 🤖
          </h2>
          <div className="flex pb-4 pt-4 justify-center items-center px-3 w-3/5 ">
          ...
          {showSignupForm && (
            <div className="mt-5">
              ℹ️ It's best to use your twitter username when registering for
              this app
            </div>
          )}
          ...
          <div
            ...
            className="text-sm mt-5 underline hover:opacity-90 cursor-pointer"
          >
            {showSignupForm
